...
def menusecundario():
  ...
  print('\n\033[1;49;92m 2° --> CONTATOS \033[m')
  print('\n\033[1;49;92m 3° --> PERFIL \033[m')
  print('\n\033[1;49;92m 4° --> MENU PRINCIPAL \033[m')
  print('\n\033[1;49;92m 5° --> REDEFINIR LOGIN \033[m')
  print('\n\033[1;49;92m 6° --> ENCERRAR \033[m')

  s=input('\n\033[1;49;34m Você deseja ir para onde? Digite: \n(1) para fazer EVENTO. \n(2) para fazer CONTATOS. \n(3) para ver seu PERFIL. \n(4) para MENU PRINCIPAL. \n(5) para REDEFINIR LOGIN. \n(6) para ENCERRAR o PLANNER \n\n\033[m')
  return s
...
def abrirms():
  while True:
    ...
    if ms == '4':
      menu()
    if ms == '5':
      print('obrigado por acessar o PLANNER TIGR')
      break
